...
// IPAddresses provides a mock function with no fields
func (_m *mockNetInterface) IPAddresses() v1.IPAddressInterface {
	ret := _m.Called()

	if len(ret) == 0 {
		panic("no return value specified for IPAddresses")
	}

	var r0 v1.IPAddressInterface
	if rf, ok := ret.Get(0).(func() v1.IPAddressInterface); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(v1.IPAddressInterface)
		}
	}
...
// mockNetInterface_IPAddresses_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'IPAddresses'
type mockNetInterface_IPAddresses_Call struct {
	*mock.Call
}

// IPAddresses is a helper method to define mock.On call
func (_e *mockNetInterface_Expecter) IPAddresses() *mockNetInterface_IPAddresses_Call {
	return &mockNetInterface_IPAddresses_Call{Call: _e.mock.On("IPAddresses")}
}

func (_c *mockNetInterface_IPAddresses_Call) Run(run func()) *mockNetInterface_IPAddresses_Call {
...
func (_c *mockNetInterface_IPAddresses_Call) Return(_a0 v1.IPAddressInterface) *mockNetInterface_IPAddresses_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *mockNetInterface_IPAddresses_Call) RunAndReturn(run func() v1.IPAddressInterface) *mockNetInterface_IPAddresses_Call {
	_c.Call.Return(run)
	return _c
}

// IngressClasses provides a mock function with no fields
...
// ServiceCIDRs provides a mock function with no fields
func (_m *mockNetInterface) ServiceCIDRs() v1.ServiceCIDRInterface {
	ret := _m.Called()

	if len(ret) == 0 {
		panic("no return value specified for ServiceCIDRs")
	}

	var r0 v1.ServiceCIDRInterface
	if rf, ok := ret.Get(0).(func() v1.ServiceCIDRInterface); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(v1.ServiceCIDRInterface)
		}
	}
...
// mockNetInterface_ServiceCIDRs_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'ServiceCIDRs'
type mockNetInterface_ServiceCIDRs_Call struct {
	*mock.Call
}

// ServiceCIDRs is a helper method to define mock.On call
func (_e *mockNetInterface_Expecter) ServiceCIDRs() *mockNetInterface_ServiceCIDRs_Call {
	return &mockNetInterface_ServiceCIDRs_Call{Call: _e.mock.On("ServiceCIDRs")}
}

func (_c *mockNetInterface_ServiceCIDRs_Call) Run(run func()) *mockNetInterface_ServiceCIDRs_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run()
	})
	return _c
...
func (_c *mockNetInterface_ServiceCIDRs_Call) Return(_a0 v1.ServiceCIDRInterface) *mockNetInterface_ServiceCIDRs_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *mockNetInterface_ServiceCIDRs_Call) RunAndReturn(run func() v1.ServiceCIDRInterface) *mockNetInterface_ServiceCIDRs_Call {
	_c.Call.Return(run)
	return _c
}
...
func newMockNetInterface(t interface {
	mock.TestingT
	Cleanup(func())
}) *mockNetInterface {
