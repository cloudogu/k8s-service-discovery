...
type mockConstructorTestingTnewMockCesSelfSignedSSLGenerator interface {
	mock.TestingT
	Cleanup(func())
}
...
func newMockCesSelfSignedSSLGenerator(t mockConstructorTestingTnewMockCesSelfSignedSSLGenerator) *mockCesSelfSignedSSLGenerator {
