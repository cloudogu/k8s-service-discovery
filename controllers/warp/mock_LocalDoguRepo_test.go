...
func (_m *MockLocalDoguRepo) GetAll(_a0 context.Context, _a1 []dogu.DoguVersion) (map[dogu.DoguVersion]*core.Dogu, error) {
...
func (_c *MockLocalDoguRepo_GetAll_Call) Run(run func(_a0 context.Context, _a1 []dogu.DoguVersion)) *MockLocalDoguRepo_GetAll_Call {
...
func (_c *MockLocalDoguRepo_GetAll_Call) Return(_a0 map[dogu.DoguVersion]*core.Dogu, _a1 error) *MockLocalDoguRepo_GetAll_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockLocalDoguRepo_GetAll_Call) RunAndReturn(run func(context.Context, []dogu.DoguVersion) (map[dogu.DoguVersion]*core.Dogu, error)) *MockLocalDoguRepo_GetAll_Call {
	_c.Call.Return(run)
	return _c
}

type mockConstructorTestingTNewMockLocalDoguRepo interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewMockLocalDoguRepo(t mockConstructorTestingTNewMockLocalDoguRepo) *MockLocalDoguRepo {
