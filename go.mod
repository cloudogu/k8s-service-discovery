...
// Traefik uses this mechanism for its enterprise codebase.
// Without the stubs go mod vendor will return errors because the ext package ist not available.
replace github.com/traefik/traefik/dynamic/ext => ./stubs/traefik-ee/ext
