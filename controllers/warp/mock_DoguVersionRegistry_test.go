...
func (_m *MockDoguVersionRegistry) WatchAllCurrent(_a0 context.Context) (dogu.CurrentVersionsWatch, error) {
	ret := _m.Called(_a0)
...
func (_c *MockDoguVersionRegistry_WatchAllCurrent_Call) Return(_a0 dogu.CurrentVersionsWatch, _a1 error) *MockDoguVersionRegistry_WatchAllCurrent_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockDoguVersionRegistry_WatchAllCurrent_Call) RunAndReturn(run func(context.Context) (dogu.CurrentVersionsWatch, error)) *MockDoguVersionRegistry_WatchAllCurrent_Call {
	_c.Call.Return(run)
	return _c
}
