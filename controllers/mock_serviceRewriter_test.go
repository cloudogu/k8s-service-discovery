...
type mockConstructorTestingTnewMockServiceRewriter interface {
	mock.TestingT
	Cleanup(func())
}
...
func newMockServiceRewriter(t mockConstructorTestingTnewMockServiceRewriter) *mockServiceRewriter {
