...
// WriteCertificate provides a mock function with given fields: ctx, certType, cert, key
func (_m *mockCesSSLWriter) WriteCertificate(ctx context.Context, certType string, cert string, key string) error {
	ret := _m.Called(ctx, certType, cert, key)
...
//   - cert string
//   - key string
func (_e *mockCesSSLWriter_Expecter) WriteCertificate(ctx interface{}, certType interface{}, cert interface{}, key interface{}) *mockCesSSLWriter_WriteCertificate_Call {
	return &mockCesSSLWriter_WriteCertificate_Call{Call: _e.mock.On("WriteCertificate", ctx, certType, cert, key)}
}

func (_c *mockCesSSLWriter_WriteCertificate_Call) Run(run func(ctx context.Context, certType string, cert string, key string)) *mockCesSSLWriter_WriteCertificate_Call {
...
func (_c *mockCesSSLWriter_WriteCertificate_Call) RunAndReturn(run func(context.Context, string, string, string) error) *mockCesSSLWriter_WriteCertificate_Call {
	_c.Call.Return(run)
	return _c
}
