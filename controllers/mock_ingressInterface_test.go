...
type mockConstructorTestingTnewMockIngressInterface interface {
	mock.TestingT
	Cleanup(func())
}
...
func newMockIngressInterface(t mockConstructorTestingTnewMockIngressInterface) *mockIngressInterface {
