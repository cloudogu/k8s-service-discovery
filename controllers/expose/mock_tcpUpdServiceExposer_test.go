...
func (_m *mockTcpUpdServiceExposer) ExposePorts(ctx context.Context, namespace string, exposedPorts types.ExposedPorts, owner *v1.OwnerReference) {
	_m.Called(ctx, namespace, exposedPorts, owner)
}

// mockTcpUpdServiceExposer_ExposePorts_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'ExposePorts'
type mockTcpUpdServiceExposer_ExposePorts_Call struct {
	*mock.Call
}
...
func (_e *mockTcpUpdServiceExposer_Expecter) ExposePorts(ctx interface{}, namespace interface{}, exposedPorts interface{}, owner interface{}) *mockTcpUpdServiceExposer_ExposePorts_Call {
	return &mockTcpUpdServiceExposer_ExposePorts_Call{Call: _e.mock.On("ExposePorts", ctx, namespace, exposedPorts, owner)}
}

func (_c *mockTcpUpdServiceExposer_ExposePorts_Call) Run(run func(ctx context.Context, namespace string, exposedPorts types.ExposedPorts, owner *v1.OwnerReference)) *mockTcpUpdServiceExposer_ExposePorts_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *mockTcpUpdServiceExposer_ExposePorts_Call) Return() *mockTcpUpdServiceExposer_ExposePorts_Call {
	_c.Call.Return()
	return _c
}

func (_c *mockTcpUpdServiceExposer_ExposePorts_Call) RunAndReturn(run func(context.Context, string, types.ExposedPorts, *v1.OwnerReference)) *mockTcpUpdServiceExposer_ExposePorts_Call {
	_c.Run(run)
	return _c
}
