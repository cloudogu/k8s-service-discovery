...
type mockConstructorTestingTnewMockIngressController interface {
	mock.TestingT
	Cleanup(func())
}
...
func newMockIngressController(t mockConstructorTestingTnewMockIngressController) *mockIngressController {
