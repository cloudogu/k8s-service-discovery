...
func (_m *mockTcpUpdServiceExposer) ExposePorts(ctx context.Context, namespace string, exposedPorts types.ExposedPorts, owner *v1.OwnerReference) error {
...
func (_c *mockTcpUpdServiceExposer_ExposePorts_Call) Return(_a0 error) *mockTcpUpdServiceExposer_ExposePorts_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *mockTcpUpdServiceExposer_ExposePorts_Call) RunAndReturn(run func(context.Context, string, types.ExposedPorts, *v1.OwnerReference) error) *mockTcpUpdServiceExposer_ExposePorts_Call {
	_c.Call.Return(run)
	return _c
}
