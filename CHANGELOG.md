...
## [Unreleased]
### Changed
- [#112] add new label "k8s.cloudogu.com/port-exposer" to create expose port in loadbalancer

## [v6.1.3] - 2026-09-23
### Changed
- [#119] Update traefik dependency to fix CVE-2026-65600 and CVE-2026-88007.
...
## [v6.0.1] - 2026-03-25
### Security
- [#103] Fix `google.golang.org/grpc` CVE-2026-33186
...
> [!IMPORTANT]
> Breaking change!
> k8s-ces-gateway 2.x.x is now needed because it is used to create the ingressclass.
