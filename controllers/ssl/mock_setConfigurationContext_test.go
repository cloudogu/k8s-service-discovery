...
type mockConstructorTestingTnewMockSetConfigurationContext interface {
	mock.TestingT
	Cleanup(func())
}
...
func newMockSetConfigurationContext(t mockConstructorTestingTnewMockSetConfigurationContext) *mockSetConfigurationContext {
